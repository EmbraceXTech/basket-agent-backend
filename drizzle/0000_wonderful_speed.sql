...
CREATE TABLE "wallet_keys" (
	...
	CONSTRAINT "wallet_keys_walletAddress_unique" UNIQUE("walletAddress")
);
--> statement-breakpoint
...
ALTER TABLE "agents" ADD CONSTRAINT "agents_walletKeyId_wallet_keys_id_fk" FOREIGN KEY ("walletKeyId") REFERENCES "public"."wallet_keys"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
